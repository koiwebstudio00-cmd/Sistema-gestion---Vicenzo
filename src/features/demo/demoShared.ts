export type UserRole = 'JEFE' | 'JULIA' | 'MILI' | 'ENCARGADO' | 'PRODUCCION' | 'TIO_FRANCO' | 'CATERING' | 'GUILLERMINA' | 'CLIENTE' | 'INVITADO' | 'CONTROL';
...
export type EventCategory = 'CASAMIENTO' | '15_ANOS' | 'CORPORATIVO' | 'CUMPLEANOS' | 'ANIVERSARIO' | 'EGRESADO' | 'OTRO';
...
export interface ServiceItem {
  ...
  isMandatory?: boolean;
  type?: 'SIMPLE' | 'PER_PERSON';
}

export const USERS: User[] = [
  { id: '1', name: 'Franco', role: 'JEFE' },
  { id: '2', name: 'Julia', role: 'JULIA' },
  ...
  { id: 'ctl1', name: 'Control Salón', role: 'CONTROL', email: 'control@vicenzo.com' },
  { id: 'cli1', name: 'Dueños de la Fiesta', role: 'CLIENTE', email: 'cliente@vicenzo.com' },
...
export const EVENTS_DATA: Event[] = [
  ...
  { id: '2', title: 'Quinceañera Valentina Suárez', date: '2026-03-07', category: '15_ANOS', guests: 160, status: 'SENA_EN_PROCESO', balance: 4800000, total: 18200000, paid: 13400000, responsable: 'Jorge Suárez', salon: 'Vicenzo', start_date: '2026-03-07T21:00:00', end_date: '2026-03-08T05:00:00', phones: ['3515556789'], salon_min_guests: 150, adult_guests: 100, young_guests: 60 },
  ...
  { id: '10', title: 'Quinceañera Sofía Méndez', date: '2026-04-12', category: '15_ANOS', guests: 150, status: 'SENA_EN_PROCESO', balance: 5000000, total: 17000000, paid: 12000000, responsable: 'Hugo Méndez' },
  ...
  { id: '14', title: 'Quinceañera Camila Fernández', date: '2026-05-10', category: '15_ANOS', guests: 160, status: 'CONFIRMADO', balance: 0, total: 18000000, paid: 18000000, responsable: 'Raúl Fernández' },
  ...
  { id: '18', title: 'Quinceañera Valentina López', date: '2026-06-14', category: '15_ANOS', guests: 180, status: 'SENA_EN_PROCESO', balance: 8000000, total: 19000000, paid: 11000000, responsable: 'Sergio López' },
  ...
  { id: '21', title: 'Quinceañera Sofía Pérez', date: '2026-07-12', category: '15_ANOS', guests: 160, status: 'CONFIRMADO', balance: 0, total: 18000000, paid: 18000000, responsable: 'Pedro Pérez' },
  ...
  { id: '25', title: 'Quinceañera Valentina Ruiz', date: '2026-09-13', category: '15_ANOS', guests: 180, status: 'SENA_EN_PROCESO', balance: 8000000, total: 19000000, paid: 11000000, responsable: 'Fabián Ruiz' },
  ...
  { id: '29', title: 'Quinceañera Camila Fernández', date: '2026-11-08', category: '15_ANOS', guests: 160, status: 'CONFIRMADO', balance: 0, total: 18000000, paid: 18000000, responsable: 'Raúl Fernández' },
...
export const CATALOG_DATA: ServiceItem[] = [
  { id: 't1', category: 'TÉCNICA & SONIDO', name: 'Alquiler Salón / Seña', priceArs: 2000000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: true, type: 'SIMPLE' },
  { id: 't2', category: 'TÉCNICA & SONIDO', name: 'Base Técnica', priceArs: 1150000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: true, type: 'SIMPLE' },
  { id: 't3', category: 'TÉCNICA & SONIDO', name: 'Cabina DJ con pantallas en pista', priceArs: 130000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', authorityId: '5', isMandatory: false, type: 'SIMPLE' },
  { id: 't4', category: 'TÉCNICA & SONIDO', name: 'Barras Láser Beam', priceArs: 215000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: false, type: 'SIMPLE' },
  { id: 't5', category: 'TÉCNICA & SONIDO', name: 'Craquera', priceArs: 120000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: false, type: 'SIMPLE' },
  { id: 't6', category: 'TÉCNICA & SONIDO', name: '12 Cabezales Aro LED', priceArs: 210000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: false, type: 'SIMPLE' },
  { id: 't7', category: 'TÉCNICA & SONIDO', name: 'Pantallas Laterales', priceArs: 220000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: false, type: 'SIMPLE' },
  { id: 't8', category: 'TÉCNICA & SONIDO', name: 'Pack Premium', priceArs: 740000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: false, type: 'SIMPLE' },
  { id: 't9', category: 'TÉCNICA & SONIDO', name: 'Sonido exterior', priceArs: 30000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: false, type: 'SIMPLE' },
  { id: 't10', category: 'TÉCNICA & SONIDO', name: 'Grupo Electrógeno', priceArs: 500000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: true, type: 'SIMPLE' },
  ...
  { id: 'c1', category: 'CATERING JÓVENES', name: 'Menú Jóvenes 15 años (por persona)', priceArs: 53000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'c2', category: 'CATERING JÓVENES', name: 'Recepción tipo KFC (por persona)', priceArs: 7700, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'c3', category: 'CATERING JÓVENES', name: 'Barra de helados (por persona)', priceArs: 7700, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'c4', category: 'CATERING JÓVENES', name: 'Barra de tragos (por persona)', priceArs: 4100, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'c5', category: 'CATERING JÓVENES', name: 'Combo tragos + KFC (por persona)', priceArs: 9500, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'a1', category: 'MENÚ ADULTOS', name: 'Menú 1 Adultos (por persona)', priceArs: 67000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'a2', category: 'MENÚ ADULTOS', name: 'Menú 2 Gourmet — pollo (por persona)', priceArs: 75000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'a3', category: 'MENÚ ADULTOS', name: 'Menú 2 Gourmet — lomo (por persona)', priceArs: 86000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'a4', category: 'MENÚ ADULTOS', name: 'Buffet 1 — 3 elementos (por persona)', priceArs: 17500, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'a5', category: 'MENÚ ADULTOS', name: 'Buffet 2 — 4 elementos (por persona)', priceArs: 22500, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'p1', category: 'PERSONAL', name: 'Mozo (por 12 hs)', priceArs: 52000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'SIMPLE' },
  { id: 'd1', category: 'DECORACIÓN', name: 'Juego de living (por juego)', priceArs: 35000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', authorityId: '5', type: 'SIMPLE' },
  { id: 'd2', category: 'DECORACIÓN', name: 'Mesas altas + banquetas (por juego)', priceArs: 20000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', authorityId: '5', type: 'SIMPLE' },
  { id: 'd3', category: 'DECORACIÓN', name: 'Fundas de silla (por unidad)', priceArs: 800, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'PER_PERSON' },
  { id: 'd4', category: 'DECORACIÓN', name: 'Alas LED', priceArs: 15000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'SIMPLE' },
  { id: 'd5', category: 'DECORACIÓN', name: 'Cortinas LED', priceArs: 20000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'SIMPLE' },
  { id: 'd6', category: 'DECORACIÓN', name: 'Guirnaldas exterior', priceArs: 20000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'SIMPLE' },
  { id: 'd7', category: 'DECORACIÓN', name: 'Buzón', priceArs: 10000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'SIMPLE' },
  { id: 'd8', category: 'DECORACIÓN', name: 'Cabina fotográfica (3 horas)', priceArs: 100000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', type: 'SIMPLE' },
  { id: 'tax1', category: 'IMPUESTOS', name: 'IVA', priceArs: 200000, priceUsd: null, currency: 'ARS', vigencia: 'Desde 01/03/25', isMandatory: true, type: 'SIMPLE' },
];
